          ...
          <div className="flex-1 text-center lg:text-left">
            <div className="flex flex-col items-center lg:items-start">
              ...
              <p className="text-sm mb-4">
                ...
                and accessible voting with real-time counting and user-friendly
                features.
              </p>
            ...
            <div className="flex flex-col items-center lg:items-left">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-center justify-center lg:justify-start space-x-2 transition-transform duration-200 hover:translate-x-2">
                  ...
                  <a href="/" className="hover:text-popBlue">
                    Home
                  </a>
                </li>
                <li className="flex items-center justify-center lg:justify-start space-x-2 transition-transform duration-200 hover:translate-x-2">
                  <GoTriangleRight className="text-sm" />
                  <a href="/feature" className="hover:text-popBlue">
                    Feature
                  </a>
                </li>
                <li className="flex items-center justify-center lg:justify-start space-x-2 transition-transform duration-200 hover:translate-x-2">
                  <GoTriangleRight className="text-sm" />
                  <a href="/aboutus" className="hover:text-popBlue">
                    About Us
                  </a>
                </li>
                <li className="flex items-center justify-center lg:justify-start space-x-2 transition-transform duration-200 hover:translate-x-2">
                  <GoTriangleRight className="text-sm" />
                  <a href="/contactus" className="hover:text-popBlue">
                    Contact Us
                  </a>
                </li>
              </ul>
          ...
          <div className="flex-1 text-center lg:text-end">
            <div className="flex flex-col items-center lg:items-end">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a href="tel:+9779804030403" className="hover:text-cyan-400">
                    +977-9804030403
                  </a>
                </li>
                <li>
                  <a href="tel:+9779826330488" className="hover:text-cyan-400">
                    +977-9826330488
                  </a>
                </li>
                <li>
                  <a href="tel:+9779824370198" className="hover:text-cyan-400">
                    +977-9824370198
                  </a>
                </li>
              </ul>
