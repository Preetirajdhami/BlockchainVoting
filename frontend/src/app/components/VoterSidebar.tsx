...
import { User, Vote, BarChart3, LogOut, Menu, X, Shield } from "lucide-react"

const navigation = [
  { name: "Profile", href: "/voter/voterPanel/profile", icon: User },
  { name: "Voting Area", href: "/voter/voterPanel/voting-area", icon: Vote },
  { name: "Result", href: "/voter/voterPanel/result", icon: BarChart3 },
]
          ...
          <div className="flex items-center px-6 py-8 border-b border-gray-100">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Voter Portal</p>
              </div>
            </div>
          </div>
